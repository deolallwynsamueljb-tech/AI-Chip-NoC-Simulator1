...
export const ResearchOverview: React.FC = () => {
  return (
    <div className="bg-[#161b22] border border-[#30363d] rounded p-4 shadow-sm space-y-4 text-[#c9d1d9]">
      ...
      <div className="bg-[#0d1117] border border-emerald-500/50 rounded p-3 space-y-2">
        ...
        <blockquote className="border-l-2 border-emerald-400 pl-3 py-1 text-[10px] font-mono text-emerald-300 bg-[#161b22] rounded-r">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 font-mono text-[10px]">
          {/* Card 1: CNN */}
          <div className="bg-[#0d1117] border border-[#30363d] rounded p-3 space-y-1.5">
            ...
            <div className="pt-1.5 border-t border-[#30363d] flex items-center gap-1 text-emerald-400 font-bold">
          ...
          <div className="bg-[#0d1117] border border-[#30363d] rounded p-3 space-y-1.5">
            ...
            <div className="pt-1.5 border-t border-[#30363d] flex items-center gap-1 text-purple-300 font-bold">
              <ArrowRight className="w-3 h-3" />
          ...
          <div className="bg-[#0d1117] border border-[#30363d] rounded p-3 space-y-1.5">
            ...
            <div className="pt-1.5 border-t border-[#30363d] flex items-center gap-1 text-cyan-300 font-bold">
              <ArrowRight className="w-3 h-3" />
